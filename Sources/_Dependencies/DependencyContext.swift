...
public enum DependencyContext: Sendable {
  ...
  ///
  /// _Dependencies accessed from a live context will use ``DependencyKey/liveValue`` to request a
  /// default value.
  case live
  ...
  ///
  /// _Dependencies accessed from a preview context will use ``TestDependencyKey/previewValue-8u2sy``
  ...
  ///
  /// _Dependencies accessed from a test context will use ``TestDependencyKey/testValue`` to request
  /// a default value.
  case test
}
